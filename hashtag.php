   ...
   <div class="page-wrapper">
      ...
      <div class="page-container"><div class="section__content section__content--p30"><div class="container-fluid">
         <div class="row"><div class="col-md-12">
            ...
            <!-- Comprobar hashtags seleccionados -->
            <?php $cantidadSeleccionados = checkHashtagsSeleccionados();
               if ($cantidadSeleccionados > 0) { ?>
                  <div class="row">

                     <!-- Grafica de comparacion-->
                     <?php require "appweb/mod/hashtags/graficascomparacion.php"; ?>
                     
                     <!-- Resumen de clasificación-->
                     <?php require "appweb/mod/hashtags/resumencomparacion.php"; ?>
            ...
            <div class="table-data__tool"><div class="table-responsive table-responsive-data2">
               ...
               <div class="table-data__tool">
                  ...
                  <!-- Panel izquierdo -->
                  <?php require "appweb/mod/hashtags/panelizquierdo.php"; ?>

                  <!-- Panel derecho -->
                  <?php require "appweb/mod/hashtags/panelderecho.php"; ?>

               </div>

               <!-- Tabla de resultados -->
               <?php require "appweb/mod/hashtags/tablaHashtags.php"; ?>
