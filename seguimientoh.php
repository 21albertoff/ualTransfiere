      ...
      <div class="page-container"><div class="section__content section__content--p30"><div class="container-fluid">
         <div class="row"><div class="col-md-12">
            ...
            <div class="row">
               ...
               <!-- Grafico Historico -->
               <?php require "appweb/mod/hashtags/graficashistorica.php"; ?>

               <!-- Grafico Quesitos -->
               <?php require "appweb/mod/hashtags/graficasquesitos.php"; ?>
            ...
            <div class="table-data__tool"><div class="table-responsive table-responsive-data2">
               ...
               <!-- Tabla de resultados -->
               <?php require "appweb/mod/hashtags/tablaseguimientoh.php"; ?>        
